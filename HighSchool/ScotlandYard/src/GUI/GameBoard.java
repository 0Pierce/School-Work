 ...
 * Date: 4th of May
 * Course Code:ICS4U1
 * Title: SDP#1 GameBoard Subclass of SurfaceGUI
 * Description: Handles the visuals and some logic of the GameBoard
 * Features: Creates GameBoard GUI, Handles Button actions
 * Major Skills: All OOP aspects, Most GUI aspects
 */
...
public class GameBoard extends SurfaceGUI {
	...
	//BlurTravelLog blur = new BlurTravelLog();
...
//------------------------------------------------------------------------------------------			
		...
		//Map.setIcon(new ImageIcon("C:\\Users\\pierc\\Desktop\\ScotlandYardImages\\TheSMap.png"));
		//Map.setBounds(0, 199, 884, 662);
		//contentPane.add(Map);
...
//------------------------------------------------------------------------------------------	
		...
		lblRain.setIcon(new ImageIcon("images/Rain.gif"));
...
//-----------------------------------------------------------------
				if (b == 1 && count < 3) {
					...
					File sound = new File("TurnSwitch.wav");
					try {
...
//Since b == 0 means its Mr.Xs turn, it shows Mr.X labels and hides Detective Labels
...
//------------------------------------------------------------------------------------------	
		...
		title.setIcon(new ImageIcon("images/title.gif"));
...
//------------------------------------------------------------------------------------------
	...
	public void VictoryCheck() {
		...
		if (turncounter >= 22) {
			...
			lblNewLabel_2.setIcon(new ImageIcon("images/giphy (1).gif"));
			lblNewLabel_2.setBounds(0, 0, 434, 261);
			contentPane.add(lblNewLabel_2);

			//This check does not work as i lack others code as it was not completed yet
			//But the flag should indicate if the detectives have surrounded MR.x or are on top of him
