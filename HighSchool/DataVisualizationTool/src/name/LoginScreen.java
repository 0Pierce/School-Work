...
public class LoginScreen extends JFrame {
	...
	public void LoginScreenGUI() {
		...
		lblTitle.setIcon(new ImageIcon("DVTImages\\Login\\Title.png"));

		JLabel lblUsername = new JLabel("", SwingConstants.CENTER);
		lblUsername.setIcon(new ImageIcon("Desktop\\DVTImages\\Login\\Username.png"));

		textFieldUser = new RoundedJTextField(10);
		

		JLabel lblPassword = new JLabel("", SwingConstants.CENTER);
		lblPassword.setIcon(new ImageIcon("DVTImages\\Login\\Password.png"));

		
		
		//Uses the custom made JText/Password fields
		textFieldPassword = new RoundedJPasswordField(10);
		//textFieldPassword.setColumns(10);

		JLabel lblLogin = new JLabel("", SwingConstants.CENTER);
		lblLogin.setIcon(new ImageIcon("DVTImages\\Login\\Login2.png"));
		...
		lblLogin.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent me) {
				...
				lblLogin.setIcon(new ImageIcon("DVTImages\\Login\\LoginHover2.png"));
			...
			public void mousePressed(MouseEvent me) {
				Border border = BorderFactory.createLineBorder(new Color(212, 94, 0), 3);
				lblLogin.setBorder(border);
				lblLogin.setIcon(new ImageIcon("DVTImages\\Login\\LoginPressed2.png"));
	...
	//Checks the JText fields if the correct password was entered
	public void CheckCreds(String ans1, String ans2) {
		...
		if (ans1.equals(username) && ans2.equals(password)) {
			...
			File sound = new File("DVTImages\\Sounds\\Granted.wav");
			try {
		...
		//Plays a sound file if the incorrect password was entered
		}else if(ans1 != username || ans2 != password) {
			//System.out.println("Entered denied");
			
			
			
			File sound = new File("DVTImages\\Sounds\\Denied.wav");
			try {
				Clip clip = AudioSystem.getClip();
				clip.open(AudioSystem.getAudioInputStream(sound));
				clip.start();
