...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
  ...
  private int pathLength(Position<E> pos, int depth) {
      if (pos == null)
          return 0;
      
      int pathLength = depth; 

      // Check the lenght of both left and right subtrees
      if (left(pos) != null)
          pathLength += pathLength(left(pos), depth + 1);
      if (right(pos) != null)
          pathLength += pathLength(right(pos), depth + 1);
  ...
  public static void main(String[] args) {
	    ...
	    Position<Integer> grandChild = tree.addLeft(leftChild, 4);

	    // Print the path length of the tree
