...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
  ...
  public int height(Position<E> p) {
	    if (isExternal(p)) {
	      return 0; // Height of external nodes is 0
	    } else {
	      int leftHeight = 0, rightHeight = 0;
	      if (left(p) != null) {
	        leftHeight = height(left(p)); 
	      }
	      if (right(p) != null) {
	        rightHeight = height(right(p));
	      }
  ...
  //Prints the element and the height
	  public void printPositionAndHeight() {
		 //Displays all of the data for each node, element and height
	    for (Position<E> p : postOrder()) {
	      System.out.println("Element: " + p.getElement() + ", Height: " + height(p));
	    }
	  }
  ...
  public static void main(String[] args) {
	  ...
	  // Test the printPositionAndHeight method
