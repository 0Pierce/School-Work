...
public Integer  indexOf(String s) {
    ...
    //Go through the entire list, until all the elements are found
    while (temp != trailer) {
        if (temp.getElement() != null && temp.getElement().equals(s)) {
            return i;
        }
        i++;
        temp = temp.getNext();
...
public static void main(String[] args) {
    ...
    list.addLast("banana");
    list.addLast("orange");
    System.out.println("Index of 'banana': " + list.indexOf("apple"));
    System.out.println("Index of 'banana': " + list.indexOf("banana")); // Should print 1
    System.out.println("Not in list");
    System.out.println("Index of 'grape': " + list.indexOf("grape"));   // Should print -1
}
