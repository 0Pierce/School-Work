...
public class FarmArea extends JFrame {

	public	JLabel lblyr2001 = new JLabel("");
	public JLabel lblyr2006 = new JLabel("");
	public JLabel lblyr2011 = new JLabel("");
	public JLabel lblyr2016 = new JLabel("");
	...
	public void FarmAreaFrame() {
		...
		//Adds the instructions label and the tooltip info
		...
		lblIns.setToolTipText("<html>" + "HOW TO USE:" + "<br>" + "1| Select a year" + "<br>" + "2| Select a region"
				...
				+ "Click on the top left menu to select a new frame" + "<br>" + "The North Eastern region has no data"
...
////----------------------------------------------------------------------
	...
	public void paint(Graphics g) {
		...
		MapPanel.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent me) {
				...
				//It gets the XY coords of the mouse click and compares it to the shape
				//Same for all the other polylines
	...
	public void PieChart() {
		...
		//The dataset and chartpanel setup
	...
	private PieDataset createDataset() {
		...
		//Each region is split up for more convinient array manipulation
		...
		// string array
		try {
			//Each BR objects represents the data which is used to then read in
			...
			while ((row = br.readLine()) != null) {
				...
				// Takes in the first(0) index from temp which are the region names
				csvData[i] = temp[0];
		...
		// Probably could have done with less code but for simplicity sake i just did
		// ifs.
		if (year == 2001) {
