...
public class percentGraph1991TO2016 extends JPanel{
	
	private static fileImport files;
	private static percentStorage[] tempData;
	public percentGraph1991TO2016(){
		...
		JFreeChart chart = ChartFactory.createBarChart(
				"Percent Change of Rental Rate 1991-2016", 		
				"Region",		
				"Percent",
				dataset,
...
private static CategoryDataset createDataset() {
		...
		tempData = fileImport.importPercentYear1991TO2016();
