...
public class LinkedStack<E> implements Stack<E> {
  ...
  public static <E> void transfer(LinkedStack<E> sourceS, LinkedStack<E> targetS) {
	  
	  //Runs until the source Stack is empty
      while (!sourceS.isEmpty()) {
    	  //Pops the elements in sourceS and then put them into the target stack
          E element = sourceS.pop();
		  ...
		  throws CloneNotSupportedException
  {
	  ...
	  LinkedStack<String> target = new LinkedStack<>();
	  
	  transfer(ls, target);
	  //Print the two stacks and show their difference
	  System.out.println("Original Stack after transfer: " + ls.toString());
	  System.out.println("Target Stack after transfer: " + target.toString());
  } 
}
