...
public String getMax() {
	  if (isEmpty()) {
	    ...
	    Node<E> current = tail.getNext(); // Get first node
	    E max = current.getElement(); // init the max with the first element
	    // go through the list to find the first element
	    int i = 0;
	    while ( i < size) {
...
//main method
  public static void main(String[] args)
  {
      ...
      try {
          String maxElement = circularList.getMax();
