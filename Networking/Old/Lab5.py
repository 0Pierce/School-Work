...
def questionC():
    ...
    threads = []
    for url in urls:
        thread = threading.Thread(target=download_file, args=(url,f"downloads/image_{i}.jpg"))
...
if __name__ == "__main__":
    ...
    parser.add_argument('method', choices=['serial', 'threaded'], help='Method: serial or threaded')
