...
namespace Lab54
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\pierc\Downloads\insurance.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"sex", @"sex"),new InputOutputColumnPair(@"smoker", @"smoker"),new InputOutputColumnPair(@"region", @"region")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=11,NumberOfTrees=14,MaximumBinCountPerFeature=44,FeatureFraction=0.843924800228878,LearningRate=0.551718821983368,LabelColumnName=@"charges",FeatureColumnName=@"Features",DiskTranspose=false}));
